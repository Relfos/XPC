...
Type
  ...
  ListNode = Class(ASTNode)
    Public
      ...
      Function Add(Element:ASTNode):Boolean; Overload;
      Function AddList(List:ListNode):Boolean; Overload;

      Function InsertAt(Index:Integer; Element:ASTNode):Boolean; Overload;
      Function InsertListAt(Index:Integer; List:ListNode):Boolean; Overload;
...
Function ListNode.Add(Element:ASTNode):Boolean;
Var
  I:Integer;
Begin
  Result := False;
...
Function ListNode.AddList(List: ListNode):Boolean;
Var
  I:Integer;
Begin
  Result := False;
  ...
  If Self.Add(List.Elements[I]) Then
    Result := True;
End;

Function ListNode.InsertListAt(Index:Integer; List:ListNode):Boolean;
Var
  I, N:Integer;
Begin
  Result := False;
  ...
  For I:=0 To Pred(List.Count) Do
  Begin
    If Self.InsertAt(N, List.Elements[I]) Then
    Begin
      Result := True;
      Inc(N);
    End;
...
Function ListNode.InsertAt(Index:Integer; Element:ASTNode):Boolean;
Var
  I:Integer;
Begin
  Result := False;
  ...
  If (Element Is ListNode) Then
  Begin
    Result := Self.InsertListAt(Index, ListNode(Element));
    Exit;
  End;
