...
{$IFDEF LLVM_DYNAMIC_LINK}
function BindLLVM(ABind: Boolean = True): Boolean;
var
  BindResult: Boolean;

  function BindLLVMProc(const AProcName: String; AAllowNotFound: Boolean = False): Pointer;
  begin
    if ABind then
    begin
...
{$ENDIF}
  ...
  @LLVMContextDispose := BindLLVMProc('LLVMContextDispose');
  @LLVMGetMDKindIDInContext := BindLLVMProc('LLVMGetMDKindIDInContext');
  @LLVMGetMDKindID := BindLLVMProc('LLVMGetMDKindID');
  @LLVMModuleCreateWithName := BindLLVMProc('LLVMModuleCreateWithName');
  @LLVMModuleCreateWithNameInContext := BindLLVMProc('LLVMModuleCreateWithNameInContext');
  @LLVMDisposeModule := BindLLVMProc('LLVMDisposeModule');
  @LLVMGetDataLayout := BindLLVMProc('LLVMGetDataLayout');
  @LLVMSetDataLayout := BindLLVMProc('LLVMSetDataLayout');
  ...
  @LLVMGetNamedMetadataNumOperands := BindLLVMProc('LLVMGetNamedMetadataNumOperands');
  @LLVMGetNamedMetadataOperands := BindLLVMProc('LLVMGetNamedMetadataOperands');
  @LLVMAddNamedMetadataOperand := BindLLVMProc('LLVMAddNamedMetadataOperand');
  @LLVMAddFunction := BindLLVMProc('LLVMAddFunction');
  @LLVMGetNamedFunction := BindLLVMProc('LLVMGetNamedFunction');
  @LLVMGetFirstFunction := BindLLVMProc('LLVMGetFirstFunction');
  @LLVMGetLastFunction := BindLLVMProc('LLVMGetLastFunction');
  @LLVMGetNextFunction := BindLLVMProc('LLVMGetNextFunction');
  @LLVMGetPreviousFunction := BindLLVMProc('LLVMGetPreviousFunction');
  @LLVMGetTypeKind := BindLLVMProc('LLVMGetTypeKind');
  @LLVMTypeIsSized := BindLLVMProc('LLVMTypeIsSized');
  @LLVMGetTypeContext := BindLLVMProc('LLVMGetTypeContext');
  @LLVMInt1TypeInContext := BindLLVMProc('LLVMInt1TypeInContext');
  @LLVMInt8TypeInContext := BindLLVMProc('LLVMInt8TypeInContext');
  @LLVMInt16TypeInContext := BindLLVMProc('LLVMInt16TypeInContext');
  @LLVMInt32TypeInContext := BindLLVMProc('LLVMInt32TypeInContext');
  @LLVMInt64TypeInContext := BindLLVMProc('LLVMInt64TypeInContext');
  @LLVMIntTypeInContext := BindLLVMProc('LLVMIntTypeInContext');
  @LLVMInt1Type := BindLLVMProc('LLVMInt1Type');
  @LLVMInt8Type := BindLLVMProc('LLVMInt8Type');
  @LLVMInt16Type := BindLLVMProc('LLVMInt16Type');
  @LLVMInt32Type := BindLLVMProc('LLVMInt32Type');
  @LLVMInt64Type := BindLLVMProc('LLVMInt64Type');
  @LLVMIntType := BindLLVMProc('LLVMIntType');
  @LLVMGetIntTypeWidth := BindLLVMProc('LLVMGetIntTypeWidth');
  @LLVMHalfTypeInContext := BindLLVMProc('LLVMHalfTypeInContext');
  @LLVMFloatTypeInContext := BindLLVMProc('LLVMFloatTypeInContext');
  @LLVMDoubleTypeInContext := BindLLVMProc('LLVMDoubleTypeInContext');
  @LLVMX86FP80TypeInContext := BindLLVMProc('LLVMX86FP80TypeInContext');
  @LLVMFP128TypeInContext := BindLLVMProc('LLVMFP128TypeInContext');
  @LLVMPPCFP128TypeInContext := BindLLVMProc('LLVMPPCFP128TypeInContext');
  @LLVMHalfType := BindLLVMProc('LLVMHalfType');
  @LLVMFloatType := BindLLVMProc('LLVMFloatType');
  @LLVMDoubleType := BindLLVMProc('LLVMDoubleType');
  @LLVMX86FP80Type := BindLLVMProc('LLVMX86FP80Type');
  @LLVMFP128Type := BindLLVMProc('LLVMFP128Type');
  @LLVMPPCFP128Type := BindLLVMProc('LLVMPPCFP128Type');
  @LLVMFunctionType := BindLLVMProc('LLVMFunctionType');
  @LLVMIsFunctionVarArg := BindLLVMProc('LLVMIsFunctionVarArg');
  @LLVMGetReturnType := BindLLVMProc('LLVMGetReturnType');
  @LLVMCountParamTypes := BindLLVMProc('LLVMCountParamTypes');
  @LLVMGetParamTypes := BindLLVMProc('LLVMGetParamTypes');
  @LLVMStructTypeInContext := BindLLVMProc('LLVMStructTypeInContext');
  @LLVMStructType := BindLLVMProc('LLVMStructType');
  @LLVMStructCreateNamed := BindLLVMProc('LLVMStructCreateNamed');
  @LLVMGetStructName := BindLLVMProc('LLVMGetStructName');
  @LLVMStructSetBody := BindLLVMProc('LLVMStructSetBody');
  @LLVMCountStructElementTypes := BindLLVMProc('LLVMCountStructElementTypes');
  @LLVMGetStructElementTypes := BindLLVMProc('LLVMGetStructElementTypes');
  @LLVMIsPackedStruct := BindLLVMProc('LLVMIsPackedStruct');
  @LLVMIsOpaqueStruct := BindLLVMProc('LLVMIsOpaqueStruct');
  @LLVMGetElementType := BindLLVMProc('LLVMGetElementType');
  @LLVMArrayType := BindLLVMProc('LLVMArrayType');
  @LLVMGetArrayLength := BindLLVMProc('LLVMGetArrayLength');
  @LLVMPointerType := BindLLVMProc('LLVMPointerType');
  @LLVMGetPointerAddressSpace := BindLLVMProc('LLVMGetPointerAddressSpace');
  @LLVMVectorType := BindLLVMProc('LLVMVectorType');
  @LLVMGetVectorSize := BindLLVMProc('LLVMGetVectorSize');
  @LLVMVoidTypeInContext := BindLLVMProc('LLVMVoidTypeInContext');
  @LLVMLabelTypeInContext := BindLLVMProc('LLVMLabelTypeInContext');
  @LLVMX86MMXTypeInContext := BindLLVMProc('LLVMX86MMXTypeInContext');
  @LLVMVoidType := BindLLVMProc('LLVMVoidType');
  @LLVMLabelType := BindLLVMProc('LLVMLabelType');
  @LLVMX86MMXType := BindLLVMProc('LLVMX86MMXType');
  @LLVMTypeOf := BindLLVMProc('LLVMTypeOf');
  @LLVMGetValueName := BindLLVMProc('LLVMGetValueName');
  @LLVMSetValueName := BindLLVMProc('LLVMSetValueName');
  @LLVMDumpValue := BindLLVMProc('LLVMDumpValue');
  @LLVMReplaceAllUsesWith := BindLLVMProc('LLVMReplaceAllUsesWith');
  @LLVMIsConstant := BindLLVMProc('LLVMIsConstant');
  @LLVMIsUndef := BindLLVMProc('LLVMIsUndef');
  @LLVMIsAArgument := BindLLVMProc('LLVMIsAArgument');
  @LLVMIsABasicBlock := BindLLVMProc('LLVMIsABasicBlock');
  @LLVMIsAInlineAsm := BindLLVMProc('LLVMIsAInlineAsm');
  @LLVMIsAMDNode := BindLLVMProc('LLVMIsAMDNode');
  @LLVMIsAMDString := BindLLVMProc('LLVMIsAMDString');
  @LLVMIsAUser := BindLLVMProc('LLVMIsAUser');
  @LLVMIsAConstant := BindLLVMProc('LLVMIsAConstant');
  @LLVMIsABlockAddress := BindLLVMProc('LLVMIsABlockAddress');
  @LLVMIsAConstantAggregateZero := BindLLVMProc('LLVMIsAConstantAggregateZero');
  @LLVMIsAConstantArray := BindLLVMProc('LLVMIsAConstantArray');
  @LLVMIsAConstantExpr := BindLLVMProc('LLVMIsAConstantExpr');
  @LLVMIsAConstantFP := BindLLVMProc('LLVMIsAConstantFP');
  @LLVMIsAConstantInt := BindLLVMProc('LLVMIsAConstantInt');
  @LLVMIsAConstantPointerNull := BindLLVMProc('LLVMIsAConstantPointerNull');
  @LLVMIsAConstantStruct := BindLLVMProc('LLVMIsAConstantStruct');
  @LLVMIsAConstantVector := BindLLVMProc('LLVMIsAConstantVector');
  @LLVMIsAGlobalValue := BindLLVMProc('LLVMIsAGlobalValue');
  @LLVMIsAFunction := BindLLVMProc('LLVMIsAFunction');
  @LLVMIsAGlobalAlias := BindLLVMProc('LLVMIsAGlobalAlias');
  @LLVMIsAGlobalVariable := BindLLVMProc('LLVMIsAGlobalVariable');
  @LLVMIsAUndefValue := BindLLVMProc('LLVMIsAUndefValue');
  @LLVMIsAInstruction := BindLLVMProc('LLVMIsAInstruction');
  @LLVMIsABinaryOperator := BindLLVMProc('LLVMIsABinaryOperator');
  @LLVMIsACallInst := BindLLVMProc('LLVMIsACallInst');
  @LLVMIsAIntrinsicInst := BindLLVMProc('LLVMIsAIntrinsicInst');
  @LLVMIsADbgInfoIntrinsic := BindLLVMProc('LLVMIsADbgInfoIntrinsic');
  @LLVMIsADbgDeclareInst := BindLLVMProc('LLVMIsADbgDeclareInst');
  @LLVMIsAMemIntrinsic := BindLLVMProc('LLVMIsAMemIntrinsic');
  @LLVMIsAMemCpyInst := BindLLVMProc('LLVMIsAMemCpyInst');
  @LLVMIsAMemMoveInst := BindLLVMProc('LLVMIsAMemMoveInst');
  @LLVMIsAMemSetInst := BindLLVMProc('LLVMIsAMemSetInst');
  @LLVMIsACmpInst := BindLLVMProc('LLVMIsACmpInst');
  @LLVMIsAFCmpInst := BindLLVMProc('LLVMIsAFCmpInst');
  @LLVMIsAICmpInst := BindLLVMProc('LLVMIsAICmpInst');
  @LLVMIsAExtractElementInst := BindLLVMProc('LLVMIsAExtractElementInst');
  @LLVMIsAGetElementPtrInst := BindLLVMProc('LLVMIsAGetElementPtrInst');
  @LLVMIsAInsertElementInst := BindLLVMProc('LLVMIsAInsertElementInst');
  @LLVMIsAInsertValueInst := BindLLVMProc('LLVMIsAInsertValueInst');
  @LLVMIsALandingPadInst := BindLLVMProc('LLVMIsALandingPadInst');
  @LLVMIsAPHINode := BindLLVMProc('LLVMIsAPHINode');
  @LLVMIsASelectInst := BindLLVMProc('LLVMIsASelectInst');
  @LLVMIsAShuffleVectorInst := BindLLVMProc('LLVMIsAShuffleVectorInst');
  @LLVMIsAStoreInst := BindLLVMProc('LLVMIsAStoreInst');
  @LLVMIsATerminatorInst := BindLLVMProc('LLVMIsATerminatorInst');
  @LLVMIsABranchInst := BindLLVMProc('LLVMIsABranchInst');
  @LLVMIsAIndirectBrInst := BindLLVMProc('LLVMIsAIndirectBrInst');
  @LLVMIsAInvokeInst := BindLLVMProc('LLVMIsAInvokeInst');
  @LLVMIsAReturnInst := BindLLVMProc('LLVMIsAReturnInst');
  @LLVMIsASwitchInst := BindLLVMProc('LLVMIsASwitchInst');
  @LLVMIsAUnreachableInst := BindLLVMProc('LLVMIsAUnreachableInst');
  @LLVMIsAResumeInst := BindLLVMProc('LLVMIsAResumeInst');
  @LLVMIsAUnaryInstruction := BindLLVMProc('LLVMIsAUnaryInstruction');
  @LLVMIsAAllocaInst := BindLLVMProc('LLVMIsAAllocaInst');
  @LLVMIsACastInst := BindLLVMProc('LLVMIsACastInst');
  @LLVMIsABitCastInst := BindLLVMProc('LLVMIsABitCastInst');
  @LLVMIsAFPExtInst := BindLLVMProc('LLVMIsAFPExtInst');
  @LLVMIsAFPToSIInst := BindLLVMProc('LLVMIsAFPToSIInst');
  @LLVMIsAFPToUIInst := BindLLVMProc('LLVMIsAFPToUIInst');
  @LLVMIsAFPTruncInst := BindLLVMProc('LLVMIsAFPTruncInst');
  @LLVMIsAIntToPtrInst := BindLLVMProc('LLVMIsAIntToPtrInst');
  @LLVMIsAPtrToIntInst := BindLLVMProc('LLVMIsAPtrToIntInst');
  @LLVMIsASExtInst := BindLLVMProc('LLVMIsASExtInst');
  @LLVMIsASIToFPInst := BindLLVMProc('LLVMIsASIToFPInst');
  @LLVMIsATruncInst := BindLLVMProc('LLVMIsATruncInst');
  @LLVMIsAUIToFPInst := BindLLVMProc('LLVMIsAUIToFPInst');
  @LLVMIsAZExtInst := BindLLVMProc('LLVMIsAZExtInst');
  @LLVMIsAExtractValueInst := BindLLVMProc('LLVMIsAExtractValueInst');
  @LLVMIsALoadInst := BindLLVMProc('LLVMIsALoadInst');
  @LLVMIsAVAArgInst := BindLLVMProc('LLVMIsAVAArgInst');
  @LLVMGetFirstUse := BindLLVMProc('LLVMGetFirstUse');
  @LLVMGetNextUse := BindLLVMProc('LLVMGetNextUse');
  @LLVMGetUser := BindLLVMProc('LLVMGetUser');
  @LLVMGetUsedValue := BindLLVMProc('LLVMGetUsedValue');
  @LLVMGetOperand := BindLLVMProc('LLVMGetOperand');
  @LLVMSetOperand := BindLLVMProc('LLVMSetOperand');
  @LLVMGetNumOperands := BindLLVMProc('LLVMGetNumOperands');
  @LLVMConstNull := BindLLVMProc('LLVMConstNull');
  @LLVMConstAllOnes := BindLLVMProc('LLVMConstAllOnes');
  @LLVMGetUndef := BindLLVMProc('LLVMGetUndef');
  @LLVMIsNull := BindLLVMProc('LLVMIsNull');
  @LLVMConstPointerNull := BindLLVMProc('LLVMConstPointerNull');
  @LLVMConstInt := BindLLVMProc('LLVMConstInt');
  @LLVMConstIntOfArbitraryPrecision := BindLLVMProc('LLVMConstIntOfArbitraryPrecision');
  @LLVMConstIntOfString := BindLLVMProc('LLVMConstIntOfString');
  @LLVMConstIntOfStringAndSize := BindLLVMProc('LLVMConstIntOfStringAndSize');
  @LLVMConstReal := BindLLVMProc('LLVMConstReal');
  @LLVMConstRealOfString := BindLLVMProc('LLVMConstRealOfString');
  @LLVMConstRealOfStringAndSize := BindLLVMProc('LLVMConstRealOfStringAndSize');
  @LLVMConstIntGetZExtValue := BindLLVMProc('LLVMConstIntGetZExtValue');
  @LLVMConstIntGetSExtValue := BindLLVMProc('LLVMConstIntGetSExtValue');
  @LLVMConstStringInContext := BindLLVMProc('LLVMConstStringInContext');
  @LLVMConstString := BindLLVMProc('LLVMConstString');
  @LLVMConstStructInContext := BindLLVMProc('LLVMConstStructInContext');
  @LLVMConstStruct := BindLLVMProc('LLVMConstStruct');
  @LLVMConstArray := BindLLVMProc('LLVMConstArray');
  @LLVMConstNamedStruct := BindLLVMProc('LLVMConstNamedStruct');
  @LLVMConstVector := BindLLVMProc('LLVMConstVector');
  @LLVMGetConstOpcode := BindLLVMProc('LLVMGetConstOpcode');
  @LLVMAlignOf := BindLLVMProc('LLVMAlignOf');
  @LLVMSizeOf := BindLLVMProc('LLVMSizeOf');
  @LLVMConstNeg := BindLLVMProc('LLVMConstNeg');
  @LLVMConstNSWNeg := BindLLVMProc('LLVMConstNSWNeg');
  @LLVMConstNUWNeg := BindLLVMProc('LLVMConstNUWNeg');
  @LLVMConstFNeg := BindLLVMProc('LLVMConstFNeg');
  @LLVMConstNot := BindLLVMProc('LLVMConstNot');
  @LLVMConstAdd := BindLLVMProc('LLVMConstAdd');
  @LLVMConstNSWAdd := BindLLVMProc('LLVMConstNSWAdd');
  @LLVMConstNUWAdd := BindLLVMProc('LLVMConstNUWAdd');
  @LLVMConstFAdd := BindLLVMProc('LLVMConstFAdd');
  @LLVMConstSub := BindLLVMProc('LLVMConstSub');
  @LLVMConstNSWSub := BindLLVMProc('LLVMConstNSWSub');
  @LLVMConstNUWSub := BindLLVMProc('LLVMConstNUWSub');
  @LLVMConstFSub := BindLLVMProc('LLVMConstFSub');
  @LLVMConstMul := BindLLVMProc('LLVMConstMul');
  @LLVMConstNSWMul := BindLLVMProc('LLVMConstNSWMul');
  @LLVMConstNUWMul := BindLLVMProc('LLVMConstNUWMul');
  @LLVMConstFMul := BindLLVMProc('LLVMConstFMul');
  @LLVMConstUDiv := BindLLVMProc('LLVMConstUDiv');
  @LLVMConstSDiv := BindLLVMProc('LLVMConstSDiv');
  @LLVMConstExactSDiv := BindLLVMProc('LLVMConstExactSDiv');
  @LLVMConstFDiv := BindLLVMProc('LLVMConstFDiv');
  @LLVMConstURem := BindLLVMProc('LLVMConstURem');
  @LLVMConstSRem := BindLLVMProc('LLVMConstSRem');
  @LLVMConstFRem := BindLLVMProc('LLVMConstFRem');
  @LLVMConstAnd := BindLLVMProc('LLVMConstAnd');
  @LLVMConstOr := BindLLVMProc('LLVMConstOr');
  @LLVMConstXor := BindLLVMProc('LLVMConstXor');
  @LLVMConstICmp := BindLLVMProc('LLVMConstICmp');
  @LLVMConstFCmp := BindLLVMProc('LLVMConstFCmp');
  @LLVMConstShl := BindLLVMProc('LLVMConstShl');
  @LLVMConstLShr := BindLLVMProc('LLVMConstLShr');
  @LLVMConstAShr := BindLLVMProc('LLVMConstAShr');
  @LLVMConstGEP := BindLLVMProc('LLVMConstGEP');
  @LLVMConstInBoundsGEP := BindLLVMProc('LLVMConstInBoundsGEP');
  @LLVMConstTrunc := BindLLVMProc('LLVMConstTrunc');
  @LLVMConstSExt := BindLLVMProc('LLVMConstSExt');
  @LLVMConstZExt := BindLLVMProc('LLVMConstZExt');
  @LLVMConstFPTrunc := BindLLVMProc('LLVMConstFPTrunc');
  @LLVMConstFPExt := BindLLVMProc('LLVMConstFPExt');
  @LLVMConstUIToFP := BindLLVMProc('LLVMConstUIToFP');
  @LLVMConstSIToFP := BindLLVMProc('LLVMConstSIToFP');
  @LLVMConstFPToUI := BindLLVMProc('LLVMConstFPToUI');
  @LLVMConstFPToSI := BindLLVMProc('LLVMConstFPToSI');
  @LLVMConstPtrToInt := BindLLVMProc('LLVMConstPtrToInt');
  @LLVMConstIntToPtr := BindLLVMProc('LLVMConstIntToPtr');
  @LLVMConstBitCast := BindLLVMProc('LLVMConstBitCast');
  @LLVMConstZExtOrBitCast := BindLLVMProc('LLVMConstZExtOrBitCast');
  @LLVMConstSExtOrBitCast := BindLLVMProc('LLVMConstSExtOrBitCast');
  @LLVMConstTruncOrBitCast := BindLLVMProc('LLVMConstTruncOrBitCast');
  @LLVMConstPointerCast := BindLLVMProc('LLVMConstPointerCast');
  @LLVMConstIntCast := BindLLVMProc('LLVMConstIntCast');
  @LLVMConstFPCast := BindLLVMProc('LLVMConstFPCast');
  @LLVMConstSelect := BindLLVMProc('LLVMConstSelect');
  @LLVMConstExtractElement := BindLLVMProc('LLVMConstExtractElement');
  @LLVMConstInsertElement := BindLLVMProc('LLVMConstInsertElement');
  @LLVMConstShuffleVector := BindLLVMProc('LLVMConstShuffleVector');
  @LLVMConstExtractValue := BindLLVMProc('LLVMConstExtractValue');
  @LLVMConstInsertValue := BindLLVMProc('LLVMConstInsertValue');
  @LLVMConstInlineAsm := BindLLVMProc('LLVMConstInlineAsm');
  @LLVMBlockAddress := BindLLVMProc('LLVMBlockAddress');
  @LLVMGetGlobalParent := BindLLVMProc('LLVMGetGlobalParent');
  @LLVMIsDeclaration := BindLLVMProc('LLVMIsDeclaration');
  @LLVMGetLinkage := BindLLVMProc('LLVMGetLinkage');
  @LLVMSetLinkage := BindLLVMProc('LLVMSetLinkage');
  @LLVMGetSection := BindLLVMProc('LLVMGetSection');
  @LLVMSetSection := BindLLVMProc('LLVMSetSection');
  @LLVMGetVisibility := BindLLVMProc('LLVMGetVisibility');
  @LLVMSetVisibility := BindLLVMProc('LLVMSetVisibility');
  @LLVMGetAlignment := BindLLVMProc('LLVMGetAlignment');
  @LLVMSetAlignment := BindLLVMProc('LLVMSetAlignment');
  @LLVMAddGlobal := BindLLVMProc('LLVMAddGlobal');
  @LLVMAddGlobalInAddressSpace := BindLLVMProc('LLVMAddGlobalInAddressSpace');
  @LLVMGetNamedGlobal := BindLLVMProc('LLVMGetNamedGlobal');
  @LLVMGetFirstGlobal := BindLLVMProc('LLVMGetFirstGlobal');
  @LLVMGetLastGlobal := BindLLVMProc('LLVMGetLastGlobal');
  @LLVMGetNextGlobal := BindLLVMProc('LLVMGetNextGlobal');
  @LLVMGetPreviousGlobal := BindLLVMProc('LLVMGetPreviousGlobal');
  @LLVMDeleteGlobal := BindLLVMProc('LLVMDeleteGlobal');
  @LLVMGetInitializer := BindLLVMProc('LLVMGetInitializer');
  @LLVMSetInitializer := BindLLVMProc('LLVMSetInitializer');
  @LLVMIsThreadLocal := BindLLVMProc('LLVMIsThreadLocal');
...
{$ENDIF}
  ...
  @LLVMGetFunctionCallConv := BindLLVMProc('LLVMGetFunctionCallConv');
  @LLVMSetFunctionCallConv := BindLLVMProc('LLVMSetFunctionCallConv');
...
{$ENDIF}
  ...
  @LLVMGetParams := BindLLVMProc('LLVMGetParams');
  @LLVMGetParam := BindLLVMProc('LLVMGetParam');
  @LLVMGetParamParent := BindLLVMProc('LLVMGetParamParent');
  @LLVMGetFirstParam := BindLLVMProc('LLVMGetFirstParam');
  @LLVMGetLastParam := BindLLVMProc('LLVMGetLastParam');
  @LLVMGetNextParam := BindLLVMProc('LLVMGetNextParam');
  @LLVMGetPreviousParam := BindLLVMProc('LLVMGetPreviousParam');
  @LLVMAddAttribute := BindLLVMProc('LLVMAddAttribute');
  @LLVMRemoveAttribute := BindLLVMProc('LLVMRemoveAttribute');
  @LLVMGetAttribute := BindLLVMProc('LLVMGetAttribute');
  @LLVMSetParamAlignment := BindLLVMProc('LLVMSetParamAlignment');
  @LLVMMDStringInContext := BindLLVMProc('LLVMMDStringInContext');
  @LLVMMDString := BindLLVMProc('LLVMMDString');
  ...
  @LLVMGetBasicBlockParent := BindLLVMProc('LLVMGetBasicBlockParent');
  @LLVMGetBasicBlockTerminator := BindLLVMProc('LLVMGetBasicBlockTerminator');
  @LLVMCountBasicBlocks := BindLLVMProc('LLVMCountBasicBlocks');
  @LLVMGetBasicBlocks := BindLLVMProc('LLVMGetBasicBlocks');
  @LLVMGetFirstBasicBlock := BindLLVMProc('LLVMGetFirstBasicBlock');
  @LLVMGetLastBasicBlock := BindLLVMProc('LLVMGetLastBasicBlock');
  @LLVMGetNextBasicBlock := BindLLVMProc('LLVMGetNextBasicBlock');
  @LLVMGetPreviousBasicBlock := BindLLVMProc('LLVMGetPreviousBasicBlock');
  @LLVMGetEntryBasicBlock := BindLLVMProc('LLVMGetEntryBasicBlock');
  @LLVMAppendBasicBlockInContext := BindLLVMProc('LLVMAppendBasicBlockInContext');
  @LLVMAppendBasicBlock := BindLLVMProc('LLVMAppendBasicBlock');
  @LLVMInsertBasicBlockInContext := BindLLVMProc('LLVMInsertBasicBlockInContext');
  @LLVMInsertBasicBlock := BindLLVMProc('LLVMInsertBasicBlock');
  @LLVMDeleteBasicBlock := BindLLVMProc('LLVMDeleteBasicBlock');
  @LLVMRemoveBasicBlockFromParent := BindLLVMProc('LLVMRemoveBasicBlockFromParent');
  @LLVMMoveBasicBlockBefore := BindLLVMProc('LLVMMoveBasicBlockBefore');
  @LLVMMoveBasicBlockAfter := BindLLVMProc('LLVMMoveBasicBlockAfter');
  @LLVMGetFirstInstruction := BindLLVMProc('LLVMGetFirstInstruction');
  @LLVMGetLastInstruction := BindLLVMProc('LLVMGetLastInstruction');
  @LLVMHasMetadata := BindLLVMProc('LLVMHasMetadata');
  @LLVMGetMetadata := BindLLVMProc('LLVMGetMetadata');
  @LLVMSetMetadata := BindLLVMProc('LLVMSetMetadata');
  @LLVMGetInstructionParent := BindLLVMProc('LLVMGetInstructionParent');
  @LLVMGetNextInstruction := BindLLVMProc('LLVMGetNextInstruction');
  @LLVMGetPreviousInstruction := BindLLVMProc('LLVMGetPreviousInstruction');
  @LLVMInstructionEraseFromParent := BindLLVMProc('LLVMInstructionEraseFromParent');
  @LLVMGetInstructionOpcode := BindLLVMProc('LLVMGetInstructionOpcode');
  @LLVMGetICmpPredicate := BindLLVMProc('LLVMGetICmpPredicate');
  @LLVMSetInstructionCallConv := BindLLVMProc('LLVMSetInstructionCallConv');
  @LLVMGetInstructionCallConv := BindLLVMProc('LLVMGetInstructionCallConv');
  @LLVMAddInstrAttribute := BindLLVMProc('LLVMAddInstrAttribute');
  @LLVMRemoveInstrAttribute := BindLLVMProc('LLVMRemoveInstrAttribute');
  @LLVMSetInstrParamAlignment := BindLLVMProc('LLVMSetInstrParamAlignment');
  @LLVMIsTailCall := BindLLVMProc('LLVMIsTailCall');
  @LLVMSetTailCall := BindLLVMProc('LLVMSetTailCall');
  @LLVMGetSwitchDefaultDest := BindLLVMProc('LLVMGetSwitchDefaultDest');
  @LLVMAddIncoming := BindLLVMProc('LLVMAddIncoming');
  @LLVMCountIncoming := BindLLVMProc('LLVMCountIncoming');
  @LLVMGetIncomingValue := BindLLVMProc('LLVMGetIncomingValue');
  @LLVMGetIncomingBlock := BindLLVMProc('LLVMGetIncomingBlock');
  @LLVMCreateBuilderInContext := BindLLVMProc('LLVMCreateBuilderInContext');
  @LLVMCreateBuilder := BindLLVMProc('LLVMCreateBuilder');
  @LLVMPositionBuilder := BindLLVMProc('LLVMPositionBuilder');
  @LLVMPositionBuilderBefore := BindLLVMProc('LLVMPositionBuilderBefore');
  @LLVMPositionBuilderAtEnd := BindLLVMProc('LLVMPositionBuilderAtEnd');
  @LLVMGetInsertBlock := BindLLVMProc('LLVMGetInsertBlock');
  @LLVMClearInsertionPosition := BindLLVMProc('LLVMClearInsertionPosition');
  @LLVMInsertIntoBuilder := BindLLVMProc('LLVMInsertIntoBuilder');
  @LLVMInsertIntoBuilderWithName := BindLLVMProc('LLVMInsertIntoBuilderWithName');
  @LLVMDisposeBuilder := BindLLVMProc('LLVMDisposeBuilder');
  @LLVMSetCurrentDebugLocation := BindLLVMProc('LLVMSetCurrentDebugLocation');
  @LLVMGetCurrentDebugLocation := BindLLVMProc('LLVMGetCurrentDebugLocation');
  @LLVMSetInstDebugLocation := BindLLVMProc('LLVMSetInstDebugLocation');
  @LLVMBuildRetVoid := BindLLVMProc('LLVMBuildRetVoid');
  @LLVMBuildRet := BindLLVMProc('LLVMBuildRet');
  @LLVMBuildAggregateRet := BindLLVMProc('LLVMBuildAggregateRet');
  @LLVMBuildBr := BindLLVMProc('LLVMBuildBr');
  @LLVMBuildCondBr := BindLLVMProc('LLVMBuildCondBr');
  @LLVMBuildSwitch := BindLLVMProc('LLVMBuildSwitch');
  @LLVMBuildIndirectBr := BindLLVMProc('LLVMBuildIndirectBr');
  @LLVMBuildInvoke := BindLLVMProc('LLVMBuildInvoke');
  @LLVMBuildLandingPad := BindLLVMProc('LLVMBuildLandingPad');
  @LLVMBuildResume := BindLLVMProc('LLVMBuildResume');
  @LLVMBuildUnreachable := BindLLVMProc('LLVMBuildUnreachable');
  @LLVMAddCase := BindLLVMProc('LLVMAddCase');
  @LLVMAddDestination := BindLLVMProc('LLVMAddDestination');
  @LLVMAddClause := BindLLVMProc('LLVMAddClause');
  @LLVMSetCleanup := BindLLVMProc('LLVMSetCleanup');
  @LLVMBuildAdd := BindLLVMProc('LLVMBuildAdd');
  @LLVMBuildNSWAdd := BindLLVMProc('LLVMBuildNSWAdd');
  @LLVMBuildNUWAdd := BindLLVMProc('LLVMBuildNUWAdd');
  @LLVMBuildFAdd := BindLLVMProc('LLVMBuildFAdd');
  @LLVMBuildSub := BindLLVMProc('LLVMBuildSub');
  @LLVMBuildNSWSub := BindLLVMProc('LLVMBuildNSWSub');
  @LLVMBuildNUWSub := BindLLVMProc('LLVMBuildNUWSub');
  @LLVMBuildFSub := BindLLVMProc('LLVMBuildFSub');
  @LLVMBuildMul := BindLLVMProc('LLVMBuildMul');
  @LLVMBuildNSWMul := BindLLVMProc('LLVMBuildNSWMul');
  @LLVMBuildNUWMul := BindLLVMProc('LLVMBuildNUWMul');
  @LLVMBuildFMul := BindLLVMProc('LLVMBuildFMul');
  @LLVMBuildUDiv := BindLLVMProc('LLVMBuildUDiv');
  @LLVMBuildSDiv := BindLLVMProc('LLVMBuildSDiv');
  @LLVMBuildExactSDiv := BindLLVMProc('LLVMBuildExactSDiv');
  @LLVMBuildFDiv := BindLLVMProc('LLVMBuildFDiv');
  @LLVMBuildURem := BindLLVMProc('LLVMBuildURem');
  @LLVMBuildSRem := BindLLVMProc('LLVMBuildSRem');
  @LLVMBuildFRem := BindLLVMProc('LLVMBuildFRem');
  @LLVMBuildShl := BindLLVMProc('LLVMBuildShl');
  @LLVMBuildLShr := BindLLVMProc('LLVMBuildLShr');
  @LLVMBuildAShr := BindLLVMProc('LLVMBuildAShr');
  @LLVMBuildAnd := BindLLVMProc('LLVMBuildAnd');
  @LLVMBuildOr := BindLLVMProc('LLVMBuildOr');
  @LLVMBuildXor := BindLLVMProc('LLVMBuildXor');
  @LLVMBuildBinOp := BindLLVMProc('LLVMBuildBinOp');
  @LLVMBuildNeg := BindLLVMProc('LLVMBuildNeg');
  @LLVMBuildNSWNeg := BindLLVMProc('LLVMBuildNSWNeg');
  @LLVMBuildNUWNeg := BindLLVMProc('LLVMBuildNUWNeg');
  @LLVMBuildFNeg := BindLLVMProc('LLVMBuildFNeg');
  @LLVMBuildNot := BindLLVMProc('LLVMBuildNot');
  @LLVMBuildMalloc := BindLLVMProc('LLVMBuildMalloc');
  @LLVMBuildArrayMalloc := BindLLVMProc('LLVMBuildArrayMalloc');
  @LLVMBuildAlloca := BindLLVMProc('LLVMBuildAlloca');
  @LLVMBuildArrayAlloca := BindLLVMProc('LLVMBuildArrayAlloca');
  @LLVMBuildFree := BindLLVMProc('LLVMBuildFree');
  @LLVMBuildLoad := BindLLVMProc('LLVMBuildLoad');
  @LLVMBuildStore := BindLLVMProc('LLVMBuildStore');
  @LLVMBuildGEP := BindLLVMProc('LLVMBuildGEP');
  @LLVMBuildInBoundsGEP := BindLLVMProc('LLVMBuildInBoundsGEP');
  @LLVMBuildStructGEP := BindLLVMProc('LLVMBuildStructGEP');
  @LLVMBuildGlobalString := BindLLVMProc('LLVMBuildGlobalString');
  @LLVMBuildGlobalStringPtr := BindLLVMProc('LLVMBuildGlobalStringPtr');
  @LLVMGetVolatile := BindLLVMProc('LLVMGetVolatile');
  @LLVMSetVolatile := BindLLVMProc('LLVMSetVolatile');
  @LLVMBuildTrunc := BindLLVMProc('LLVMBuildTrunc');
  @LLVMBuildZExt := BindLLVMProc('LLVMBuildZExt');
  @LLVMBuildSExt := BindLLVMProc('LLVMBuildSExt');
  @LLVMBuildFPToUI := BindLLVMProc('LLVMBuildFPToUI');
  @LLVMBuildFPToSI := BindLLVMProc('LLVMBuildFPToSI');
  @LLVMBuildUIToFP := BindLLVMProc('LLVMBuildUIToFP');
  @LLVMBuildSIToFP := BindLLVMProc('LLVMBuildSIToFP');
  @LLVMBuildFPTrunc := BindLLVMProc('LLVMBuildFPTrunc');
  @LLVMBuildFPExt := BindLLVMProc('LLVMBuildFPExt');
  @LLVMBuildPtrToInt := BindLLVMProc('LLVMBuildPtrToInt');
  @LLVMBuildIntToPtr := BindLLVMProc('LLVMBuildIntToPtr');
  @LLVMBuildBitCast := BindLLVMProc('LLVMBuildBitCast');
  @LLVMBuildZExtOrBitCast := BindLLVMProc('LLVMBuildZExtOrBitCast');
  @LLVMBuildSExtOrBitCast := BindLLVMProc('LLVMBuildSExtOrBitCast');
  @LLVMBuildTruncOrBitCast := BindLLVMProc('LLVMBuildTruncOrBitCast');
  @LLVMBuildCast := BindLLVMProc('LLVMBuildCast');
  @LLVMBuildPointerCast := BindLLVMProc('LLVMBuildPointerCast');
  @LLVMBuildIntCast := BindLLVMProc('LLVMBuildIntCast');
  @LLVMBuildFPCast := BindLLVMProc('LLVMBuildFPCast');
  @LLVMBuildICmp := BindLLVMProc('LLVMBuildICmp');
  @LLVMBuildFCmp := BindLLVMProc('LLVMBuildFCmp');
  @LLVMBuildPhi := BindLLVMProc('LLVMBuildPhi');
  @LLVMBuildCall := BindLLVMProc('LLVMBuildCall');
  @LLVMBuildSelect := BindLLVMProc('LLVMBuildSelect');
  @LLVMBuildVAArg := BindLLVMProc('LLVMBuildVAArg');
  @LLVMBuildExtractElement := BindLLVMProc('LLVMBuildExtractElement');
  @LLVMBuildInsertElement := BindLLVMProc('LLVMBuildInsertElement');
  @LLVMBuildShuffleVector := BindLLVMProc('LLVMBuildShuffleVector');
  @LLVMBuildExtractValue := BindLLVMProc('LLVMBuildExtractValue');
  @LLVMBuildInsertValue := BindLLVMProc('LLVMBuildInsertValue');
...
{$ENDIF}
  ...
  @LLVMCreateFunctionPassManagerForModule := BindLLVMProc('LLVMCreateFunctionPassManagerForModule');
  @LLVMCreateFunctionPassManager := BindLLVMProc('LLVMCreateFunctionPassManager');
  @LLVMRunPassManager := BindLLVMProc('LLVMRunPassManager');
  @LLVMInitializeFunctionPassManager := BindLLVMProc('LLVMInitializeFunctionPassManager');
...
{$IFDEF LLVM_API_ANALYSIS}
  ...
  @LLVMVerifyModule := BindLLVMProc('LLVMVerifyModule');
  @LLVMVerifyFunction := BindLLVMProc('LLVMVerifyFunction');
  @LLVMViewFunctionCFG := BindLLVMProc('LLVMViewFunctionCFG');
  @LLVMViewFunctionCFGOnly := BindLLVMProc('LLVMViewFunctionCFGOnly');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_BITREADER}
  LLVMTraceLog(';BitReader.h');
  @LLVMParseBitcode := BindLLVMProc('LLVMParseBitcode');
  @LLVMParseBitcodeInContext := BindLLVMProc('LLVMParseBitcodeInContext');
  @LLVMGetBitcodeModuleInContext := BindLLVMProc('LLVMGetBitcodeModuleInContext');
  @LLVMGetBitcodeModule := BindLLVMProc('LLVMGetBitcodeModule');
  @LLVMGetBitcodeModuleProviderInContext := BindLLVMProc('LLVMGetBitcodeModuleProviderInContext');
  @LLVMGetBitcodeModuleProvider := BindLLVMProc('LLVMGetBitcodeModuleProvider');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_BITWRITER}
  LLVMTraceLog(';BitWriter.h');
  @LLVMWriteBitcodeToFile := BindLLVMProc('LLVMWriteBitcodeToFile');
  @LLVMWriteBitcodeToFD := BindLLVMProc('LLVMWriteBitcodeToFD');
  @LLVMWriteBitcodeToFileHandle := BindLLVMProc('LLVMWriteBitcodeToFileHandle');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_INITIALIZATION}
...
{$ENDIF}
  ...
  @LLVMInitializeInstrumentation := BindLLVMProc('LLVMInitializeInstrumentation');
  @LLVMInitializeAnalysis := BindLLVMProc('LLVMInitializeAnalysis');
  @LLVMInitializeIPA := BindLLVMProc('LLVMInitializeIPA');
  @LLVMInitializeCodeGen := BindLLVMProc('LLVMInitializeCodeGen');
...
{$IFDEF LLVM_API_LINKTIMEOPTIMIZER}
  ...
  @llvm_destroy_optimizer := BindLLVMProc('llvm_destroy_optimizer');
  @llvm_read_object_file := BindLLVMProc('llvm_read_object_file');
  @llvm_optimize_modules := BindLLVMProc('llvm_optimize_modules');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_TARGET}
  LLVMTraceLog(';Target.h');
  @LLVMInitializeAllTargetInfos := BindLLVMProc('LLVMInitializeAllTargetInfosDL');      // This function need wrapper
  @LLVMInitializeAllTargets := BindLLVMProc('LLVMInitializeAllTargetsDL');              // This function need wrapper
  @LLVMInitializeAllTargetMCs := BindLLVMProc('LLVMInitializeAllTargetMCsDL');          // This function need wrapper
  @LLVMInitializeAllAsmPrinters := BindLLVMProc('LLVMInitializeAllAsmPrintersDL');      // This function need wrapper
  @LLVMInitializeAllAsmParsers := BindLLVMProc('LLVMInitializeAllAsmParsersDL');        // This function need wrapper
  @LLVMInitializeAllDisassemblers := BindLLVMProc('LLVMInitializeAllDisassemblersDL');  // This function need wrapper
  @LLVMInitializeNativeTarget := BindLLVMProc('LLVMInitializeNativeTargetDL');          // This function need wrapper
  @LLVMCreateTargetData := BindLLVMProc('LLVMCreateTargetData');
  @LLVMAddTargetData := BindLLVMProc('LLVMAddTargetData');
  @LLVMAddTargetLibraryInfo := BindLLVMProc('LLVMAddTargetLibraryInfo');
  ...
  @LLVMABIAlignmentOfType := BindLLVMProc('LLVMABIAlignmentOfType');
  @LLVMCallFrameAlignmentOfType := BindLLVMProc('LLVMCallFrameAlignmentOfType');
  @LLVMPreferredAlignmentOfType := BindLLVMProc('LLVMPreferredAlignmentOfType');
  @LLVMPreferredAlignmentOfGlobal := BindLLVMProc('LLVMPreferredAlignmentOfGlobal');
  @LLVMElementAtOffset := BindLLVMProc('LLVMElementAtOffset');
  @LLVMOffsetOfElement := BindLLVMProc('LLVMOffsetOfElement');
  @LLVMDisposeTargetData := BindLLVMProc('LLVMDisposeTargetData');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_TARGETMACHINE}
  LLVMTraceLog(';TargetMachine.h');
  @LLVMGetFirstTarget := BindLLVMProc('LLVMGetFirstTarget');
  @LLVMGetNextTarget := BindLLVMProc('LLVMGetNextTarget');
  @LLVMGetTargetName := BindLLVMProc('LLVMGetTargetName');
  @LLVMGetTargetDescription := BindLLVMProc('LLVMGetTargetDescription');
  @LLVMTargetHasJIT := BindLLVMProc('LLVMTargetHasJIT');
  @LLVMTargetHasTargetMachine := BindLLVMProc('LLVMTargetHasTargetMachine');
  @LLVMTargetHasAsmBackend := BindLLVMProc('LLVMTargetHasAsmBackend');
  @LLVMCreateTargetMachine := BindLLVMProc('LLVMCreateTargetMachine');
  @LLVMDisposeTargetMachine := BindLLVMProc('LLVMDisposeTargetMachine');
  @LLVMGetTargetMachineTarget := BindLLVMProc('LLVMGetTargetMachineTarget');
  @LLVMGetTargetMachineTriple := BindLLVMProc('LLVMGetTargetMachineTriple');
  @LLVMGetTargetMachineCPU := BindLLVMProc('LLVMGetTargetMachineCPU');
...
{$IFDEF LLVM_API_OBJECT}
  ...
  @LLVMCreateObjectFile := BindLLVMProc('LLVMCreateObjectFile');
  @LLVMDisposeObjectFile := BindLLVMProc('LLVMDisposeObjectFile');
  @LLVMGetSections := BindLLVMProc('LLVMGetSections');
  @LLVMDisposeSectionIterator := BindLLVMProc('LLVMDisposeSectionIterator');
  @LLVMIsSectionIteratorAtEnd := BindLLVMProc('LLVMIsSectionIteratorAtEnd');
  @LLVMMoveToNextSection := BindLLVMProc('LLVMMoveToNextSection');
  @LLVMMoveToContainingSection := BindLLVMProc('LLVMMoveToContainingSection');
  @LLVMGetSymbols := BindLLVMProc('LLVMGetSymbols');
  @LLVMDisposeSymbolIterator := BindLLVMProc('LLVMDisposeSymbolIterator');
  @LLVMIsSymbolIteratorAtEnd := BindLLVMProc('LLVMIsSymbolIteratorAtEnd');
  @LLVMMoveToNextSymbol := BindLLVMProc('LLVMMoveToNextSymbol');
  @LLVMGetSectionName := BindLLVMProc('LLVMGetSectionName');
  @LLVMGetSectionSize := BindLLVMProc('LLVMGetSectionSize');
  @LLVMGetSectionContents := BindLLVMProc('LLVMGetSectionContents');
  @LLVMGetSectionAddress := BindLLVMProc('LLVMGetSectionAddress');
  @LLVMGetSectionContainsSymbol := BindLLVMProc('LLVMGetSectionContainsSymbol');
  @LLVMGetRelocations := BindLLVMProc('LLVMGetRelocations');
  @LLVMDisposeRelocationIterator := BindLLVMProc('LLVMDisposeRelocationIterator');
  @LLVMIsRelocationIteratorAtEnd := BindLLVMProc('LLVMIsRelocationIteratorAtEnd');
  @LLVMMoveToNextRelocation := BindLLVMProc('LLVMMoveToNextRelocation');
  @LLVMGetSymbolName := BindLLVMProc('LLVMGetSymbolName');
  @LLVMGetSymbolAddress := BindLLVMProc('LLVMGetSymbolAddress');
  @LLVMGetSymbolFileOffset := BindLLVMProc('LLVMGetSymbolFileOffset');
  @LLVMGetSymbolSize := BindLLVMProc('LLVMGetSymbolSize');
  @LLVMGetRelocationAddress := BindLLVMProc('LLVMGetRelocationAddress');
  @LLVMGetRelocationOffset := BindLLVMProc('LLVMGetRelocationOffset');
  @LLVMGetRelocationSymbol := BindLLVMProc('LLVMGetRelocationSymbol');
  @LLVMGetRelocationType := BindLLVMProc('LLVMGetRelocationType');
  @LLVMGetRelocationTypeName := BindLLVMProc('LLVMGetRelocationTypeName');
  @LLVMGetRelocationValueString := BindLLVMProc('LLVMGetRelocationValueString');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_EXECUTIONENGINE}
...
{$ENDIF}
  ...
  @LLVMCreateGenericValueOfFloat := BindLLVMProc('LLVMCreateGenericValueOfFloat');
  @LLVMGenericValueIntWidth := BindLLVMProc('LLVMGenericValueIntWidth');
  @LLVMGenericValueToInt := BindLLVMProc('LLVMGenericValueToInt');
  @LLVMGenericValueToPointer := BindLLVMProc('LLVMGenericValueToPointer');
  @LLVMGenericValueToFloat := BindLLVMProc('LLVMGenericValueToFloat');
  @LLVMDisposeGenericValue := BindLLVMProc('LLVMDisposeGenericValue');
...
{$ENDIF}
  ...
  @LLVMDisposeExecutionEngine := BindLLVMProc('LLVMDisposeExecutionEngine');
  @LLVMRunStaticConstructors := BindLLVMProc('LLVMRunStaticConstructors');
  @LLVMRunStaticDestructors := BindLLVMProc('LLVMRunStaticDestructors');
  @LLVMRunFunctionAsMain := BindLLVMProc('LLVMRunFunctionAsMain');
  @LLVMRunFunction := BindLLVMProc('LLVMRunFunction');
  @LLVMFreeMachineCodeForFunction := BindLLVMProc('LLVMFreeMachineCodeForFunction');
  @LLVMAddModule := BindLLVMProc('LLVMAddModule');
  @LLVMAddModuleProvider := BindLLVMProc('LLVMAddModuleProvider');
  @LLVMRemoveModule := BindLLVMProc('LLVMRemoveModule');
  @LLVMRemoveModuleProvider := BindLLVMProc('LLVMRemoveModuleProvider');
  @LLVMFindFunction := BindLLVMProc('LLVMFindFunction');
  @LLVMRecompileAndRelinkFunction := BindLLVMProc('LLVMRecompileAndRelinkFunction');
  @LLVMGetExecutionEngineTargetData := BindLLVMProc('LLVMGetExecutionEngineTargetData');
  @LLVMAddGlobalMapping := BindLLVMProc('LLVMAddGlobalMapping');
  @LLVMGetPointerToGlobal := BindLLVMProc('LLVMGetPointerToGlobal');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_DISASSEMBLER}
...
{$IFDEF LLVM_API_LTO}
  LLVMTraceLog(';lto.h');
  @lto_get_version := BindLLVMProc('lto_get_version');
  @lto_get_error_message := BindLLVMProc('lto_get_error_message');
  @lto_module_is_object_file := BindLLVMProc('lto_module_is_object_file');
  @lto_module_is_object_file_for_target := BindLLVMProc('lto_module_is_object_file_for_target');
  @lto_module_is_object_file_in_memory := BindLLVMProc('lto_module_is_object_file_in_memory');
  @lto_module_is_object_file_in_memory_for_target := BindLLVMProc('lto_module_is_object_file_in_memory_for_target');
  @lto_module_create := BindLLVMProc('lto_module_create');
  @lto_module_create_from_memory := BindLLVMProc('lto_module_create_from_memory');
  @lto_module_create_from_fd := BindLLVMProc('lto_module_create_from_fd');
  @lto_module_create_from_fd_at_offset := BindLLVMProc('lto_module_create_from_fd_at_offset');
  @lto_module_dispose := BindLLVMProc('lto_module_dispose');
  @lto_module_get_target_triple := BindLLVMProc('lto_module_get_target_triple');
  @lto_module_set_target_triple := BindLLVMProc('lto_module_set_target_triple');
  @lto_module_get_num_symbols := BindLLVMProc('lto_module_get_num_symbols');
  @lto_module_get_symbol_name := BindLLVMProc('lto_module_get_symbol_name');
  @lto_module_get_symbol_attribute := BindLLVMProc('lto_module_get_symbol_attribute');
  @lto_codegen_create := BindLLVMProc('lto_codegen_create');
  @lto_codegen_dispose := BindLLVMProc('lto_codegen_dispose');
  @lto_codegen_add_module := BindLLVMProc('lto_codegen_add_module');
  @lto_codegen_set_debug_model := BindLLVMProc('lto_codegen_set_debug_model');
  @lto_codegen_set_pic_model := BindLLVMProc('lto_codegen_set_pic_model');
  @lto_codegen_set_cpu := BindLLVMProc('lto_codegen_set_cpu');
  @lto_codegen_set_assembler_path := BindLLVMProc('lto_codegen_set_assembler_path');
  @lto_codegen_set_assembler_args := BindLLVMProc('lto_codegen_set_assembler_args');
  @lto_codegen_add_must_preserve_symbol := BindLLVMProc('lto_codegen_add_must_preserve_symbol');
  @lto_codegen_write_merged_modules := BindLLVMProc('lto_codegen_write_merged_modules');
...
{$IFDEF LLVM_API_ENHANCEDDISASSEMBLY}
  ...
  @EDGetRegisterName := BindLLVMProc('EDGetRegisterName');
  @EDRegisterIsStackPointer := BindLLVMProc('EDRegisterIsStackPointer');
  @EDRegisterIsProgramCounter := BindLLVMProc('EDRegisterIsProgramCounter');
  @EDCreateInsts := BindLLVMProc('EDCreateInsts');
  @EDReleaseInst := BindLLVMProc('EDReleaseInst');
  @EDInstByteSize := BindLLVMProc('EDInstByteSize');
  @EDGetInstString := BindLLVMProc('EDGetInstString');
  @EDInstID := BindLLVMProc('EDInstID');
  @EDInstIsBranch := BindLLVMProc('EDInstIsBranch');
  @EDInstIsMove := BindLLVMProc('EDInstIsMove');
  @EDBranchTargetID := BindLLVMProc('EDBranchTargetID');
  @EDMoveSourceID := BindLLVMProc('EDMoveSourceID');
  @EDMoveTargetID := BindLLVMProc('EDMoveTargetID');
  @EDNumTokens := BindLLVMProc('EDNumTokens');
  @EDGetToken := BindLLVMProc('EDGetToken');
  @EDGetTokenString := BindLLVMProc('EDGetTokenString');
  @EDOperandIndexForToken := BindLLVMProc('EDOperandIndexForToken');
  @EDTokenIsWhitespace := BindLLVMProc('EDTokenIsWhitespace');
  @EDTokenIsPunctuation := BindLLVMProc('EDTokenIsPunctuation');
  @EDTokenIsOpcode := BindLLVMProc('EDTokenIsOpcode');
  @EDTokenIsLiteral := BindLLVMProc('EDTokenIsLiteral');
  @EDTokenIsRegister := BindLLVMProc('EDTokenIsRegister');
  @EDTokenIsNegativeLiteral := BindLLVMProc('EDTokenIsNegativeLiteral');
  @EDLiteralTokenAbsoluteValue := BindLLVMProc('EDLiteralTokenAbsoluteValue');
  @EDRegisterTokenValue := BindLLVMProc('EDRegisterTokenValue');
  @EDNumOperands := BindLLVMProc('EDNumOperands');
  @EDGetOperand := BindLLVMProc('EDGetOperand');
  @EDOperandIsRegister := BindLLVMProc('EDOperandIsRegister');
  @EDOperandIsImmediate := BindLLVMProc('EDOperandIsImmediate');
  @EDOperandIsMemory := BindLLVMProc('EDOperandIsMemory');
  @EDRegisterOperandValue := BindLLVMProc('EDRegisterOperandValue');
...
{$IFDEF LLVM_API_IPO}
  LLVMTraceLog(';Ipo.h');
  @LLVMAddArgumentPromotionPass := BindLLVMProc('LLVMAddArgumentPromotionPass');
  @LLVMAddConstantMergePass := BindLLVMProc('LLVMAddConstantMergePass');
  @LLVMAddDeadArgEliminationPass := BindLLVMProc('LLVMAddDeadArgEliminationPass');
  @LLVMAddFunctionAttrsPass := BindLLVMProc('LLVMAddFunctionAttrsPass');
  @LLVMAddFunctionInliningPass := BindLLVMProc('LLVMAddFunctionInliningPass');
  @LLVMAddAlwaysInlinerPass := BindLLVMProc('LLVMAddAlwaysInlinerPass');
  @LLVMAddGlobalDCEPass := BindLLVMProc('LLVMAddGlobalDCEPass');
  @LLVMAddGlobalOptimizerPass := BindLLVMProc('LLVMAddGlobalOptimizerPass');
  @LLVMAddIPConstantPropagationPass := BindLLVMProc('LLVMAddIPConstantPropagationPass');
  @LLVMAddPruneEHPass := BindLLVMProc('LLVMAddPruneEHPass');
  @LLVMAddIPSCCPPass := BindLLVMProc('LLVMAddIPSCCPPass');
  @LLVMAddInternalizePass := BindLLVMProc('LLVMAddInternalizePass');
  @LLVMAddStripDeadPrototypesPass := BindLLVMProc('LLVMAddStripDeadPrototypesPass');
  @LLVMAddStripSymbolsPass := BindLLVMProc('LLVMAddStripSymbolsPass');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_PASSMANAGERBUILDER}
  LLVMTraceLog(';PassManagerBuilder.h');
  @LLVMPassManagerBuilderCreate := BindLLVMProc('LLVMPassManagerBuilderCreate');
  @LLVMPassManagerBuilderDispose := BindLLVMProc('LLVMPassManagerBuilderDispose');
  @LLVMPassManagerBuilderSetOptLevel := BindLLVMProc('LLVMPassManagerBuilderSetOptLevel');
  @LLVMPassManagerBuilderSetSizeLevel := BindLLVMProc('LLVMPassManagerBuilderSetSizeLevel');
  @LLVMPassManagerBuilderSetDisableUnitAtATime := BindLLVMProc('LLVMPassManagerBuilderSetDisableUnitAtATime');
  @LLVMPassManagerBuilderSetDisableUnrollLoops := BindLLVMProc('LLVMPassManagerBuilderSetDisableUnrollLoops');
  @LLVMPassManagerBuilderSetDisableSimplifyLibCalls := BindLLVMProc('LLVMPassManagerBuilderSetDisableSimplifyLibCalls');
  @LLVMPassManagerBuilderUseInlinerWithThreshold := BindLLVMProc('LLVMPassManagerBuilderUseInlinerWithThreshold');
  @LLVMPassManagerBuilderPopulateFunctionPassManager := BindLLVMProc('LLVMPassManagerBuilderPopulateFunctionPassManager');
  @LLVMPassManagerBuilderPopulateModulePassManager := BindLLVMProc('LLVMPassManagerBuilderPopulateModulePassManager');
  @LLVMPassManagerBuilderPopulateLTOPassManager := BindLLVMProc('LLVMPassManagerBuilderPopulateLTOPassManager');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_SCALAR}
  LLVMTraceLog(';Scalar.h');
  @LLVMAddAggressiveDCEPass := BindLLVMProc('LLVMAddAggressiveDCEPass');
  @LLVMAddCFGSimplificationPass := BindLLVMProc('LLVMAddCFGSimplificationPass');
  @LLVMAddDeadStoreEliminationPass := BindLLVMProc('LLVMAddDeadStoreEliminationPass');
  @LLVMAddGVNPass := BindLLVMProc('LLVMAddGVNPass');
  @LLVMAddIndVarSimplifyPass := BindLLVMProc('LLVMAddIndVarSimplifyPass');
  @LLVMAddInstructionCombiningPass := BindLLVMProc('LLVMAddInstructionCombiningPass');
  @LLVMAddJumpThreadingPass := BindLLVMProc('LLVMAddJumpThreadingPass');
  @LLVMAddLICMPass := BindLLVMProc('LLVMAddLICMPass');
  @LLVMAddLoopDeletionPass := BindLLVMProc('LLVMAddLoopDeletionPass');
  @LLVMAddLoopIdiomPass := BindLLVMProc('LLVMAddLoopIdiomPass');
  @LLVMAddLoopRotatePass := BindLLVMProc('LLVMAddLoopRotatePass');
  @LLVMAddLoopUnrollPass := BindLLVMProc('LLVMAddLoopUnrollPass');
  @LLVMAddLoopUnswitchPass := BindLLVMProc('LLVMAddLoopUnswitchPass');
  @LLVMAddMemCpyOptPass := BindLLVMProc('LLVMAddMemCpyOptPass');
  @LLVMAddPromoteMemoryToRegisterPass := BindLLVMProc('LLVMAddPromoteMemoryToRegisterPass');
  @LLVMAddReassociatePass := BindLLVMProc('LLVMAddReassociatePass');
  @LLVMAddSCCPPass := BindLLVMProc('LLVMAddSCCPPass');
  @LLVMAddScalarReplAggregatesPass := BindLLVMProc('LLVMAddScalarReplAggregatesPass');
  @LLVMAddScalarReplAggregatesPassSSA := BindLLVMProc('LLVMAddScalarReplAggregatesPassSSA');
  @LLVMAddScalarReplAggregatesPassWithThreshold := BindLLVMProc('LLVMAddScalarReplAggregatesPassWithThreshold');
  @LLVMAddSimplifyLibCallsPass := BindLLVMProc('LLVMAddSimplifyLibCallsPass');
  @LLVMAddTailCallEliminationPass := BindLLVMProc('LLVMAddTailCallEliminationPass');
  @LLVMAddConstantPropagationPass := BindLLVMProc('LLVMAddConstantPropagationPass');
  @LLVMAddDemoteMemoryToRegisterPass := BindLLVMProc('LLVMAddDemoteMemoryToRegisterPass');
  @LLVMAddVerifierPass := BindLLVMProc('LLVMAddVerifierPass');
  @LLVMAddCorrelatedValuePropagationPass := BindLLVMProc('LLVMAddCorrelatedValuePropagationPass');
  @LLVMAddEarlyCSEPass := BindLLVMProc('LLVMAddEarlyCSEPass');
  @LLVMAddLowerExpectIntrinsicPass := BindLLVMProc('LLVMAddLowerExpectIntrinsicPass');
  @LLVMAddTypeBasedAliasAnalysisPass := BindLLVMProc('LLVMAddTypeBasedAliasAnalysisPass');
  @LLVMAddBasicAliasAnalysisPass := BindLLVMProc('LLVMAddBasicAliasAnalysisPass');
  LLVMTraceLog('');
{$ENDIF}
{$IFDEF LLVM_API_VECTORIZE}
...
begin
  ...
  begin
    ...
    LLVMDebugLog('Cannot load "%s" library!', [LLVMLibrary])
end;
